...
namespace flash.events
{
	...
	/**
	 * The UncaughtErrorEvents class provides a way to receive uncaught error events. An instance of this class dispatches an 
	 * uncaughtError event when a runtime error occurs and the error isn't detected and handled in your code.
	 ...
	 * If the content loaded by a Loader object is an AVM1 (ActionScript 2) SWF file, uncaught errors in the AVM1 SWF file do not 
	 * result in an uncaughtError event. In addition, JavaScript errors in HTML content loaded in an HTMLLoader object 
