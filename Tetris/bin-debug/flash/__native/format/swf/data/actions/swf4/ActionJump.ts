...
namespace flash.__native.format.swf.data.actions.swf4
{
	...
	export  class ActionJump extends Action implements IActionBranch
	{
		...
		public static CODE:number = 0x99;
		...
		/*override*/ public clone():IAction {
			var action:ActionJump = new ActionJump(this.code, this.length, this.pos);
