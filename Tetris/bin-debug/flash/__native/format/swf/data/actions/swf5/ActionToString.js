                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionToString = (function (_super) {
                                __extends(ActionToString, _super);
                                ...
                                ActionToString.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionToString]";
                                };
                                ActionToString.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "toString";
                                };
                                ActionToString.CODE = 0x4b;
                                return ActionToString;
                            }(swf5.Action));
                            swf5.ActionToString = ActionToString;
...
//# sourceMappingURL=ActionToString.js.map