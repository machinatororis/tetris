                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionCallFunction = (function (_super) {
                                __extends(ActionCallFunction, _super);
                                ...
                                ActionCallFunction.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionCallFunction]";
                                };
                                ActionCallFunction.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "callFunction";
                                };
                                ActionCallFunction.CODE = 0x3d;
                                return ActionCallFunction;
                            }(swf5.Action));
                            swf5.ActionCallFunction = ActionCallFunction;
...
//# sourceMappingURL=ActionCallFunction.js.map