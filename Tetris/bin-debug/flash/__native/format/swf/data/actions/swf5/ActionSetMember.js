                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionSetMember = (function (_super) {
                                __extends(ActionSetMember, _super);
                                ...
                                ActionSetMember.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionSetMember]";
                                };
                                ActionSetMember.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "setMember";
                                };
                                ActionSetMember.CODE = 0x4f;
                                return ActionSetMember;
                            }(swf5.Action));
                            swf5.ActionSetMember = ActionSetMember;
...
//# sourceMappingURL=ActionSetMember.js.map