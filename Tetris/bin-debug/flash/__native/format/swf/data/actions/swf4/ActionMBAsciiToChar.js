                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionMBAsciiToChar = (function (_super) {
                                __extends(ActionMBAsciiToChar, _super);
                                ...
                                ActionMBAsciiToChar.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionMBAsciiToChar]";
                                };
                                ActionMBAsciiToChar.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "mbAsciiToChar";
                                };
                                ActionMBAsciiToChar.CODE = 0x37;
                                return ActionMBAsciiToChar;
                            }(swf4.Action));
                            swf4.ActionMBAsciiToChar = ActionMBAsciiToChar;
...
//# sourceMappingURL=ActionMBAsciiToChar.js.map