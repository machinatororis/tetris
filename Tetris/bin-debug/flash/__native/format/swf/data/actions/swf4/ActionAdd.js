                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionAdd = (function (_super) {
                                ...
                                ActionAdd.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionAdd]";
                                };
                                ActionAdd.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "add";
                                };
                                ActionAdd.CODE = 0x0a;
                                return ActionAdd;
                            }(swf4.Action));
                            swf4.ActionAdd = ActionAdd;
...
//# sourceMappingURL=ActionAdd.js.map