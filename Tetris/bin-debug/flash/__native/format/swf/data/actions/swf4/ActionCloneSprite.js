                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionCloneSprite = (function (_super) {
                                __extends(ActionCloneSprite, _super);
                                ...
                                ActionCloneSprite.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionCloneSprite]";
                                };
                                ActionCloneSprite.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "cloneSprite";
                                };
                                ActionCloneSprite.CODE = 0x24;
                                return ActionCloneSprite;
                            }(swf4.Action));
                            swf4.ActionCloneSprite = ActionCloneSprite;
...
//# sourceMappingURL=ActionCloneSprite.js.map