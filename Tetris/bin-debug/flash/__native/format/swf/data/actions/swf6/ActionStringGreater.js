                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf6) {
                            ...
                            var ActionStringGreater = (function (_super) {
                                __extends(ActionStringGreater, _super);
                                ...
                                ActionStringGreater.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringGreater]";
                                };
                                ActionStringGreater.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf6.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringGreater";
                                };
                                ActionStringGreater.CODE = 0x68;
                                return ActionStringGreater;
                            }(swf6.Action));
                            swf6.ActionStringGreater = ActionStringGreater;
...
//# sourceMappingURL=ActionStringGreater.js.map