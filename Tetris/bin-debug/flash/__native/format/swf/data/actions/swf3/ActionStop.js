                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf3) {
                            ...
                            var ActionStop = (function (_super) {
                                __extends(ActionStop, _super);
                                ...
                                ActionStop.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStop]";
                                };
                                ActionStop.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf3.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stop";
                                };
                                ActionStop.CODE = 0x07;
                                return ActionStop;
                            }(swf3.Action));
                            swf3.ActionStop = ActionStop;
...
//# sourceMappingURL=ActionStop.js.map