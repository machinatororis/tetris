                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf6) {
                            ...
                            var ActionStrictEquals = (function (_super) {
                                __extends(ActionStrictEquals, _super);
                                ...
                                ActionStrictEquals.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStrictEquals]";
                                };
                                ActionStrictEquals.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf6.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "strictEquals";
                                };
                                ActionStrictEquals.CODE = 0x66;
                                return ActionStrictEquals;
                            }(swf6.Action));
                            swf6.ActionStrictEquals = ActionStrictEquals;
...
//# sourceMappingURL=ActionStrictEquals.js.map