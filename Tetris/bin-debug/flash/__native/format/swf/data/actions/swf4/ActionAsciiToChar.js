                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionAsciiToChar = (function (_super) {
                                __extends(ActionAsciiToChar, _super);
                                ...
                                ActionAsciiToChar.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionAsciiToChar]";
                                };
                                ActionAsciiToChar.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "asciiToChar";
                                };
                                ActionAsciiToChar.CODE = 0x33;
                                return ActionAsciiToChar;
                            }(swf4.Action));
                            swf4.ActionAsciiToChar = ActionAsciiToChar;
...
//# sourceMappingURL=ActionAsciiToChar.js.map