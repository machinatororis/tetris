                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionStackSwap = (function (_super) {
                                __extends(ActionStackSwap, _super);
                                ...
                                ActionStackSwap.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStackSwap]";
                                };
                                ActionStackSwap.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stackSwap";
                                };
                                ActionStackSwap.CODE = 0x4d;
                                return ActionStackSwap;
                            }(swf5.Action));
                            swf5.ActionStackSwap = ActionStackSwap;
...
//# sourceMappingURL=ActionStackSwap.js.map