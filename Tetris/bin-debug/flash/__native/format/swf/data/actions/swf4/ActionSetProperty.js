                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionSetProperty = (function (_super) {
                                ...
                                ActionSetProperty.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionSetProperty]";
                                };
                                ActionSetProperty.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "setProperty";
                                };
                                ActionSetProperty.CODE = 0x23;
                                return ActionSetProperty;
                            }(swf4.Action));
                            swf4.ActionSetProperty = ActionSetProperty;
...
//# sourceMappingURL=ActionSetProperty.js.map