                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionMultiply = (function (_super) {
                                __extends(ActionMultiply, _super);
                                ...
                                ActionMultiply.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionMultiply]";
                                };
                                ActionMultiply.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "multiply";
                                };
                                ActionMultiply.CODE = 0x0c;
                                return ActionMultiply;
                            }(swf4.Action));
                            swf4.ActionMultiply = ActionMultiply;
...
//# sourceMappingURL=ActionMultiply.js.map