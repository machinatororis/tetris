                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionToInteger = (function (_super) {
                                __extends(ActionToInteger, _super);
                                ...
                                ActionToInteger.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionToInteger]";
                                };
                                ActionToInteger.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "toInteger";
                                };
                                ActionToInteger.CODE = 0x18;
                                return ActionToInteger;
                            }(swf4.Action));
                            swf4.ActionToInteger = ActionToInteger;
...
//# sourceMappingURL=ActionToInteger.js.map