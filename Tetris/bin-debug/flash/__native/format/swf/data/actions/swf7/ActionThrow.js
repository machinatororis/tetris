                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf7) {
                            ...
                            var ActionThrow = (function (_super) {
                                __extends(ActionThrow, _super);
                                ...
                                ActionThrow.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionThrow]";
                                };
                                ActionThrow.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf7.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "throw";
                                };
                                ActionThrow.CODE = 0x2a;
                                return ActionThrow;
                            }(swf7.Action));
                            swf7.ActionThrow = ActionThrow;
...
//# sourceMappingURL=ActionThrow.js.map