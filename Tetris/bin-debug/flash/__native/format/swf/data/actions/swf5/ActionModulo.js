                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionModulo = (function (_super) {
                                __extends(ActionModulo, _super);
                                ...
                                ActionModulo.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionModulo]";
                                };
                                ActionModulo.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "modulo";
                                };
                                ActionModulo.CODE = 0x3f;
                                return ActionModulo;
                            }(swf5.Action));
                            swf5.ActionModulo = ActionModulo;
...
//# sourceMappingURL=ActionModulo.js.map