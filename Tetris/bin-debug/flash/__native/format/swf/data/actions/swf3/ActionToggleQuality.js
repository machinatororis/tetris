                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf3) {
                            ...
                            var ActionToggleQuality = (function (_super) {
                                __extends(ActionToggleQuality, _super);
                                ...
                                ActionToggleQuality.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionToggleQuality]";
                                };
                                ActionToggleQuality.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf3.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "toggleQuality";
                                };
                                ActionToggleQuality.CODE = 0x08;
                                return ActionToggleQuality;
                            }(swf3.Action));
                            swf3.ActionToggleQuality = ActionToggleQuality;
...
//# sourceMappingURL=ActionToggleQuality.js.map