                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionEndDrag = (function (_super) {
                                __extends(ActionEndDrag, _super);
                                ...
                                ActionEndDrag.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionEndDrag]";
                                };
                                ActionEndDrag.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "endDrag";
                                };
                                ActionEndDrag.CODE = 0x28;
                                return ActionEndDrag;
                            }(swf4.Action));
                            swf4.ActionEndDrag = ActionEndDrag;
...
//# sourceMappingURL=ActionEndDrag.js.map