                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionIncrement = (function (_super) {
                                __extends(ActionIncrement, _super);
                                ...
                                ActionIncrement.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionIncrement]";
                                };
                                ActionIncrement.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "increment";
                                };
                                ActionIncrement.CODE = 0x50;
                                return ActionIncrement;
                            }(swf5.Action));
                            swf5.ActionIncrement = ActionIncrement;
...
//# sourceMappingURL=ActionIncrement.js.map