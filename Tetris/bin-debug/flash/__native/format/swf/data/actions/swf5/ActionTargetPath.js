                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionTargetPath = (function (_super) {
                                __extends(ActionTargetPath, _super);
                                ...
                                ActionTargetPath.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionTargetPath]";
                                };
                                ActionTargetPath.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "targetPath";
                                };
                                ActionTargetPath.CODE = 0x45;
                                return ActionTargetPath;
                            }(swf5.Action));
                            swf5.ActionTargetPath = ActionTargetPath;
...
//# sourceMappingURL=ActionTargetPath.js.map