                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStringLength = (function (_super) {
                                __extends(ActionStringLength, _super);
                                ...
                                ActionStringLength.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringLength]";
                                };
                                ActionStringLength.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringLength";
                                };
                                ActionStringLength.CODE = 0x14;
                                return ActionStringLength;
                            }(swf4.Action));
                            swf4.ActionStringLength = ActionStringLength;
...
//# sourceMappingURL=ActionStringLength.js.map