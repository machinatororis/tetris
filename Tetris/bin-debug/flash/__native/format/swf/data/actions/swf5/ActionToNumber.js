                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionToNumber = (function (_super) {
                                __extends(ActionToNumber, _super);
                                ...
                                ActionToNumber.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionToNumber]";
                                };
                                ActionToNumber.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "toNumber";
                                };
                                ActionToNumber.CODE = 0x4a;
                                return ActionToNumber;
                            }(swf5.Action));
                            swf5.ActionToNumber = ActionToNumber;
...
//# sourceMappingURL=ActionToNumber.js.map