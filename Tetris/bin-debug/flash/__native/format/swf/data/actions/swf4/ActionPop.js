                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionPop = (function (_super) {
                                __extends(ActionPop, _super);
                                ...
                                ActionPop.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionPop]";
                                };
                                ActionPop.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "pop";
                                };
                                ActionPop.CODE = 0x17;
                                return ActionPop;
                            }(swf4.Action));
                            swf4.ActionPop = ActionPop;
...
//# sourceMappingURL=ActionPop.js.map