                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionDivide = (function (_super) {
                                __extends(ActionDivide, _super);
                                ...
                                ActionDivide.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionDivide]";
                                };
                                ActionDivide.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "divide";
                                };
                                ActionDivide.CODE = 0x0d;
                                return ActionDivide;
                            }(swf4.Action));
                            swf4.ActionDivide = ActionDivide;
...
//# sourceMappingURL=ActionDivide.js.map