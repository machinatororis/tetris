                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionReturn = (function (_super) {
                                __extends(ActionReturn, _super);
                                ...
                                ActionReturn.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionReturn]";
                                };
                                ActionReturn.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "return";
                                };
                                ActionReturn.CODE = 0x3e;
                                return ActionReturn;
                            }(swf5.Action));
                            swf5.ActionReturn = ActionReturn;
...
//# sourceMappingURL=ActionReturn.js.map