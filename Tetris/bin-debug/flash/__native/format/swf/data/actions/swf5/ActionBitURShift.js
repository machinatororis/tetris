                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionBitURShift = (function (_super) {
                                __extends(ActionBitURShift, _super);
                                ...
                                ActionBitURShift.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionBitURShift]";
                                };
                                ActionBitURShift.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "bitURShift";
                                };
                                ActionBitURShift.CODE = 0x65;
                                return ActionBitURShift;
                            }(swf5.Action));
                            swf5.ActionBitURShift = ActionBitURShift;
...
//# sourceMappingURL=ActionBitURShift.js.map