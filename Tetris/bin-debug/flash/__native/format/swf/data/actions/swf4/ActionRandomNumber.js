                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionRandomNumber = (function (_super) {
                                __extends(ActionRandomNumber, _super);
                                ...
                                ActionRandomNumber.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionRandomNumber]";
                                };
                                ActionRandomNumber.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "randomNumber";
                                };
                                ActionRandomNumber.CODE = 0x30;
                                return ActionRandomNumber;
                            }(swf4.Action));
                            swf4.ActionRandomNumber = ActionRandomNumber;
...
//# sourceMappingURL=ActionRandomNumber.js.map