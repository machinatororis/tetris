                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionSubtract = (function (_super) {
                                __extends(ActionSubtract, _super);
                                ...
                                ActionSubtract.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionSubtract]";
                                };
                                ActionSubtract.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "subtract";
                                };
                                ActionSubtract.CODE = 0x0b;
                                return ActionSubtract;
                            }(swf4.Action));
                            swf4.ActionSubtract = ActionSubtract;
...
//# sourceMappingURL=ActionSubtract.js.map