                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStringLess = (function (_super) {
                                __extends(ActionStringLess, _super);
                                ...
                                ActionStringLess.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringLess]";
                                };
                                ActionStringLess.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringLess";
                                };
                                ActionStringLess.CODE = 0x29;
                                return ActionStringLess;
                            }(swf4.Action));
                            swf4.ActionStringLess = ActionStringLess;
...
//# sourceMappingURL=ActionStringLess.js.map