                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionGetMember = (function (_super) {
                                __extends(ActionGetMember, _super);
                                ...
                                ActionGetMember.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionGetMember]";
                                };
                                ActionGetMember.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "getMember";
                                };
                                ActionGetMember.CODE = 0x4e;
                                return ActionGetMember;
                            }(swf5.Action));
                            swf5.ActionGetMember = ActionGetMember;
...
//# sourceMappingURL=ActionGetMember.js.map