                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionAdd2 = (function (_super) {
                                __extends(ActionAdd2, _super);
                                ...
                                ActionAdd2.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionAdd2]";
                                };
                                ActionAdd2.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "add2";
                                };
                                ActionAdd2.CODE = 0x47;
                                return ActionAdd2;
                            }(swf5.Action));
                            swf5.ActionAdd2 = ActionAdd2;
...
//# sourceMappingURL=ActionAdd2.js.map