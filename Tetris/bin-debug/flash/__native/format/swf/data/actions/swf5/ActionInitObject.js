                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionInitObject = (function (_super) {
                                __extends(ActionInitObject, _super);
                                ...
                                ActionInitObject.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionInitObject]";
                                };
                                ActionInitObject.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "initObject";
                                };
                                ActionInitObject.CODE = 0x43;
                                return ActionInitObject;
                            }(swf5.Action));
                            swf5.ActionInitObject = ActionInitObject;
...
//# sourceMappingURL=ActionInitObject.js.map