                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf3) {
                            ...
                            var ActionNextFrame = (function (_super) {
                                __extends(ActionNextFrame, _super);
                                ...
                                ActionNextFrame.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionNextFrame]";
                                };
                                ActionNextFrame.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf3.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "nextFrame";
                                };
                                ActionNextFrame.CODE = 0x04;
                                return ActionNextFrame;
                            }(swf3.Action));
                            swf3.ActionNextFrame = ActionNextFrame;
...
//# sourceMappingURL=ActionNextFrame.js.map