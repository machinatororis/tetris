                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionMBStringLength = (function (_super) {
                                __extends(ActionMBStringLength, _super);
                                ...
                                ActionMBStringLength.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionMBStringLength]";
                                };
                                ActionMBStringLength.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "mbStringLength";
                                };
                                ActionMBStringLength.CODE = 0x31;
                                return ActionMBStringLength;
                            }(swf4.Action));
                            swf4.ActionMBStringLength = ActionMBStringLength;
...
//# sourceMappingURL=ActionMBStringLength.js.map