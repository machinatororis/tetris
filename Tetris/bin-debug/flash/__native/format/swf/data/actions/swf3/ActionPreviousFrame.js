                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf3) {
                            ...
                            var ActionPreviousFrame = (function (_super) {
                                __extends(ActionPreviousFrame, _super);
                                ...
                                ActionPreviousFrame.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionPreviousFrame]";
                                };
                                ActionPreviousFrame.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf3.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "previousFrame";
                                };
                                ActionPreviousFrame.CODE = 0x05;
                                return ActionPreviousFrame;
                            }(swf3.Action));
                            swf3.ActionPreviousFrame = ActionPreviousFrame;
...
//# sourceMappingURL=ActionPreviousFrame.js.map