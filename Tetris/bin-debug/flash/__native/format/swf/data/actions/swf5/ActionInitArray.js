                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionInitArray = (function (_super) {
                                __extends(ActionInitArray, _super);
                                ...
                                ActionInitArray.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionInitArray]";
                                };
                                ActionInitArray.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "initArray";
                                };
                                ActionInitArray.CODE = 0x42;
                                return ActionInitArray;
                            }(swf5.Action));
                            swf5.ActionInitArray = ActionInitArray;
...
//# sourceMappingURL=ActionInitArray.js.map