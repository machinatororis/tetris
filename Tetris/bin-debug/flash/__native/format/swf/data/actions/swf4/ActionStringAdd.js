                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStringAdd = (function (_super) {
                                __extends(ActionStringAdd, _super);
                                ...
                                ActionStringAdd.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringAdd]";
                                };
                                ActionStringAdd.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringAdd";
                                };
                                ActionStringAdd.CODE = 0x21;
                                return ActionStringAdd;
                            }(swf4.Action));
                            swf4.ActionStringAdd = ActionStringAdd;
...
//# sourceMappingURL=ActionStringAdd.js.map