                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionPushDuplicate = (function (_super) {
                                __extends(ActionPushDuplicate, _super);
                                ...
                                ActionPushDuplicate.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionPushDuplicate]";
                                };
                                ActionPushDuplicate.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "pushDuplicate";
                                };
                                ActionPushDuplicate.CODE = 0x4c;
                                return ActionPushDuplicate;
                            }(swf5.Action));
                            swf5.ActionPushDuplicate = ActionPushDuplicate;
...
//# sourceMappingURL=ActionPushDuplicate.js.map