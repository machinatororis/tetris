                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionSetVariable = (function (_super) {
                                __extends(ActionSetVariable, _super);
                                ...
                                ActionSetVariable.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionSetVariable]";
                                };
                                ActionSetVariable.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "setVariable";
                                };
                                ActionSetVariable.CODE = 0x1d;
                                return ActionSetVariable;
                            }(swf4.Action));
                            swf4.ActionSetVariable = ActionSetVariable;
...
//# sourceMappingURL=ActionSetVariable.js.map