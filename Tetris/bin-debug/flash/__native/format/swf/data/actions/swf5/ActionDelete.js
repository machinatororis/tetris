                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionDelete = (function (_super) {
                                __extends(ActionDelete, _super);
                                ...
                                ActionDelete.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionDelete]";
                                };
                                ActionDelete.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "delete";
                                };
                                ActionDelete.CODE = 0x3a;
                                return ActionDelete;
                            }(swf5.Action));
                            swf5.ActionDelete = ActionDelete;
