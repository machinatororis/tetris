                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionTrace = (function (_super) {
                                __extends(ActionTrace, _super);
                                ...
                                ActionTrace.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionTrace]";
                                };
                                ActionTrace.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "trace";
                                };
                                ActionTrace.CODE = 0x26;
                                return ActionTrace;
                            }(swf4.Action));
                            swf4.ActionTrace = ActionTrace;
...
//# sourceMappingURL=ActionTrace.js.map