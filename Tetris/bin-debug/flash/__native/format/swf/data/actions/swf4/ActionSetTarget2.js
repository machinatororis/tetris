                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionSetTarget2 = (function (_super) {
                                __extends(ActionSetTarget2, _super);
                                ...
                                ActionSetTarget2.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionSetTarget2]";
                                };
                                ActionSetTarget2.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "setTarget2";
                                };
                                ActionSetTarget2.CODE = 0x20;
                                return ActionSetTarget2;
                            }(swf4.Action));
                            swf4.ActionSetTarget2 = ActionSetTarget2;
...
//# sourceMappingURL=ActionSetTarget2.js.map