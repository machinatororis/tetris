                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionDefineLocal = (function (_super) {
                                __extends(ActionDefineLocal, _super);
                                ...
                                ActionDefineLocal.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionDefineLocal]";
                                };
                                ActionDefineLocal.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "defineLocal";
                                };
                                ActionDefineLocal.CODE = 0x3c;
                                return ActionDefineLocal;
                            }(swf5.Action));
                            swf5.ActionDefineLocal = ActionDefineLocal;
...
//# sourceMappingURL=ActionDefineLocal.js.map