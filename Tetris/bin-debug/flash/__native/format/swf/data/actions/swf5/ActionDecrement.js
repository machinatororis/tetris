                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionDecrement = (function (_super) {
                                __extends(ActionDecrement, _super);
                                ...
                                ActionDecrement.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionDecrement]";
                                };
                                ActionDecrement.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "decrement";
                                };
                                ActionDecrement.CODE = 0x51;
                                return ActionDecrement;
                            }(swf5.Action));
                            swf5.ActionDecrement = ActionDecrement;
...
//# sourceMappingURL=ActionDecrement.js.map