                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionCallMethod = (function (_super) {
                                __extends(ActionCallMethod, _super);
                                ...
                                ActionCallMethod.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionCallMethod]";
                                };
                                ActionCallMethod.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "callMethod";
                                };
                                ActionCallMethod.CODE = 0x52;
                                return ActionCallMethod;
                            }(swf5.Action));
                            swf5.ActionCallMethod = ActionCallMethod;
...
//# sourceMappingURL=ActionCallMethod.js.map