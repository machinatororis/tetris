                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionGetProperty = (function (_super) {
                                __extends(ActionGetProperty, _super);
                                ...
                                ActionGetProperty.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionGetProperty]";
                                };
                                ActionGetProperty.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "getProperty";
                                };
                                ActionGetProperty.CODE = 0x22;
                                return ActionGetProperty;
                            }(swf4.Action));
                            swf4.ActionGetProperty = ActionGetProperty;
...
//# sourceMappingURL=ActionGetProperty.js.map