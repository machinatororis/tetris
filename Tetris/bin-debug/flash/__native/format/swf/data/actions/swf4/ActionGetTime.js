                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionGetTime = (function (_super) {
                                __extends(ActionGetTime, _super);
                                ...
                                ActionGetTime.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionGetTime]";
                                };
                                ActionGetTime.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "getTime";
                                };
                                ActionGetTime.CODE = 0x34;
                                return ActionGetTime;
                            }(swf4.Action));
                            swf4.ActionGetTime = ActionGetTime;
...
//# sourceMappingURL=ActionGetTime.js.map