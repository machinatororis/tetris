                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStringEquals = (function (_super) {
                                __extends(ActionStringEquals, _super);
                                ...
                                ActionStringEquals.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringEquals]";
                                };
                                ActionStringEquals.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringEquals";
                                };
                                ActionStringEquals.CODE = 0x13;
                                return ActionStringEquals;
                            }(swf4.Action));
                            swf4.ActionStringEquals = ActionStringEquals;
...
//# sourceMappingURL=ActionStringEquals.js.map