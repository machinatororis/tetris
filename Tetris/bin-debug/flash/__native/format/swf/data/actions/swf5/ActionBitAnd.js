                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionBitAnd = (function (_super) {
                                __extends(ActionBitAnd, _super);
                                ...
                                ActionBitAnd.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionBitAnd]";
                                };
                                ActionBitAnd.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "bitAnd";
                                };
                                ActionBitAnd.CODE = 0x60;
                                return ActionBitAnd;
                            }(swf5.Action));
                            swf5.ActionBitAnd = ActionBitAnd;
...
//# sourceMappingURL=ActionBitAnd.js.map