                ...
                (function (data_1) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionIf = (function (_super) {
                                __extends(ActionIf, _super);
                                ...
                                ActionIf.prototype.parse = function (data) {
                                    data = strict(data, swf4.SWFData);
                                    this._branchOffset = data.readSI16();
                                };
                                ActionIf.prototype.publish = function (data) {
                                    data = strict(data, swf4.SWFData);
                                    var body = new swf4.SWFData();
                                    body.writeSI16(this._branchOffset);
                                    this.write(data, body);
                                };
                                ActionIf.prototype.clone = function () {
                                    var action = new ActionIf(this.code, this.length, this.pos);
                                    action.branchOffset = this._branchOffset;
                                    return action;
                                };
                                ActionIf.prototype.toString = function (indent) {
                                ...
                                ActionIf.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
