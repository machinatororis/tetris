                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStringExtract = (function (_super) {
                                __extends(ActionStringExtract, _super);
                                ...
                                ActionStringExtract.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStringExtract]";
                                };
                                ActionStringExtract.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "stringExtract";
                                };
                                ActionStringExtract.CODE = 0x15;
                                return ActionStringExtract;
                            }(swf4.Action));
                            swf4.ActionStringExtract = ActionStringExtract;
...
//# sourceMappingURL=ActionStringExtract.js.map