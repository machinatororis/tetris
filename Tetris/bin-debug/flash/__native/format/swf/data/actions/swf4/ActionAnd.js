                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionAnd = (function (_super) {
                                __extends(ActionAnd, _super);
                                ...
                                ActionAnd.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionAnd]";
                                };
                                ActionAnd.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "and";
                                };
                                ActionAnd.CODE = 0x10;
                                return ActionAnd;
                            }(swf4.Action));
                            swf4.ActionAnd = ActionAnd;
