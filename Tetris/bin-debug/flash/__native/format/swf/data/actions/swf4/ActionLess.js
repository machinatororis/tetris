                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionLess = (function (_super) {
                                __extends(ActionLess, _super);
                                ...
                                ActionLess.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionLess]";
                                };
                                ActionLess.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "less";
                                };
                                ActionLess.CODE = 0x0f;
                                return ActionLess;
                            }(swf4.Action));
                            swf4.ActionLess = ActionLess;
...
//# sourceMappingURL=ActionLess.js.map