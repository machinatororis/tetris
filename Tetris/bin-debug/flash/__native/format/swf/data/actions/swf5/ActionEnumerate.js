                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionEnumerate = (function (_super) {
                                __extends(ActionEnumerate, _super);
                                ...
                                ActionEnumerate.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionEnumerate]";
                                };
                                ActionEnumerate.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "enumerate";
                                };
                                ActionEnumerate.CODE = 0x46;
                                return ActionEnumerate;
                            }(swf5.Action));
                            swf5.ActionEnumerate = ActionEnumerate;
...
//# sourceMappingURL=ActionEnumerate.js.map