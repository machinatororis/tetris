                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionBitLShift = (function (_super) {
                                __extends(ActionBitLShift, _super);
                                ...
                                ActionBitLShift.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionBitLShift]";
                                };
                                ActionBitLShift.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "bitLShift";
                                };
                                ActionBitLShift.CODE = 0x63;
                                return ActionBitLShift;
                            }(swf5.Action));
                            swf5.ActionBitLShift = ActionBitLShift;
...
//# sourceMappingURL=ActionBitLShift.js.map