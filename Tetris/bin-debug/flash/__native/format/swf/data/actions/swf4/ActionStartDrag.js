                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionStartDrag = (function (_super) {
                                __extends(ActionStartDrag, _super);
                                ...
                                ActionStartDrag.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionStartDrag]";
                                };
                                ActionStartDrag.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "startDrag";
                                };
                                ActionStartDrag.CODE = 0x27;
                                return ActionStartDrag;
                            }(swf4.Action));
                            swf4.ActionStartDrag = ActionStartDrag;
...
//# sourceMappingURL=ActionStartDrag.js.map