                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionBitRShift = (function (_super) {
                                __extends(ActionBitRShift, _super);
                                ...
                                ActionBitRShift.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionBitRShift]";
                                };
                                ActionBitRShift.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "bitRShift";
                                };
                                ActionBitRShift.CODE = 0x64;
                                return ActionBitRShift;
                            }(swf5.Action));
                            swf5.ActionBitRShift = ActionBitRShift;
...
//# sourceMappingURL=ActionBitRShift.js.map