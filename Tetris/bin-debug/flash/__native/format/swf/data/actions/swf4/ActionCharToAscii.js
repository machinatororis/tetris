                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionCharToAscii = (function (_super) {
                                __extends(ActionCharToAscii, _super);
                                ...
                                ActionCharToAscii.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionCharToAscii]";
                                };
                                ActionCharToAscii.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "charToAscii";
                                };
                                ActionCharToAscii.CODE = 0x32;
                                return ActionCharToAscii;
                            }(swf4.Action));
                            swf4.ActionCharToAscii = ActionCharToAscii;
...
//# sourceMappingURL=ActionCharToAscii.js.map