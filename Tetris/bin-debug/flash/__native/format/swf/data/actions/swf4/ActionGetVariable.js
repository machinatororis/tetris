                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionGetVariable = (function (_super) {
                                __extends(ActionGetVariable, _super);
                                ...
                                ActionGetVariable.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionGetVariable]";
                                };
                                ActionGetVariable.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "getVariable";
                                };
                                ActionGetVariable.CODE = 0x1c;
                                return ActionGetVariable;
                            }(swf4.Action));
                            swf4.ActionGetVariable = ActionGetVariable;
...
//# sourceMappingURL=ActionGetVariable.js.map