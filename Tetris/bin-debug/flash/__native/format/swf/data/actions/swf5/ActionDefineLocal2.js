                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionDefineLocal2 = (function (_super) {
                                __extends(ActionDefineLocal2, _super);
                                ...
                                ActionDefineLocal2.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionDefineLocal2]";
                                };
                                ActionDefineLocal2.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "defineLocal2";
                                };
                                ActionDefineLocal2.CODE = 0x41;
                                return ActionDefineLocal2;
                            }(swf5.Action));
                            swf5.ActionDefineLocal2 = ActionDefineLocal2;
...
//# sourceMappingURL=ActionDefineLocal2.js.map