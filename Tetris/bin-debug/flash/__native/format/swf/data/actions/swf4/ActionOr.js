                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionOr = (function (_super) {
                                __extends(ActionOr, _super);
                                ...
                                ActionOr.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionOr]";
                                };
                                ActionOr.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "or";
                                };
                                ActionOr.CODE = 0x11;
                                return ActionOr;
                            }(swf4.Action));
                            swf4.ActionOr = ActionOr;
...
//# sourceMappingURL=ActionOr.js.map