                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionRemoveSprite = (function (_super) {
                                __extends(ActionRemoveSprite, _super);
                                ...
                                ActionRemoveSprite.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionRemoveSprite]";
                                };
                                ActionRemoveSprite.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "removeSprite";
                                };
                                ActionRemoveSprite.CODE = 0x25;
                                return ActionRemoveSprite;
                            }(swf4.Action));
                            swf4.ActionRemoveSprite = ActionRemoveSprite;
...
//# sourceMappingURL=ActionRemoveSprite.js.map