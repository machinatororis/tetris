                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf4) {
                            ...
                            var ActionCall = (function (_super) {
                                __extends(ActionCall, _super);
                                ...
                                ActionCall.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionCall]";
                                };
                                ActionCall.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf4.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "call";
                                };
                                ActionCall.CODE = 0x9e;
                                return ActionCall;
                            }(swf4.Action));
                            swf4.ActionCall = ActionCall;
