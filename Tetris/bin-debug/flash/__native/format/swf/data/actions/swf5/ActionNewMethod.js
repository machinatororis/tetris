                ...
                (function (data) {
                    ...
                    (function (actions) {
                        ...
                        (function (swf5) {
                            ...
                            var ActionNewMethod = (function (_super) {
                                __extends(ActionNewMethod, _super);
                                ...
                                ActionNewMethod.prototype.toString = function (indent) {
                                    if (indent === void 0) { indent = 0; }
                                    indent = ((indent) >>> 0);
                                    return "[ActionNewMethod]";
                                };
                                ActionNewMethod.prototype.toBytecode = function (indent, context) {
                                    indent = ((indent) >>> 0);
                                    context = strict(context, swf5.ActionExecutionContext);
                                    return this.toBytecodeLabel(indent) + "newMethod";
                                };
                                ActionNewMethod.CODE = 0x53;
                                return ActionNewMethod;
                            }(swf5.Action));
                            swf5.ActionNewMethod = ActionNewMethod;
...
//# sourceMappingURL=ActionNewMethod.js.map