...
namespace flash.filters
{
	...
	/**
	 * The GradientBevelFilter class lets you apply a gradient bevel effect to display objects. A gradient bevel is a beveled edge, 
	 * enhanced with gradient color, on the outside, inside, or top of an object. Beveled edges make objects look three-dimensional. 
	 ...
	 * if the object itself is scaled (if scaleX and scaleY are set to a value other than 1.0), the filter effect is not scaled. 
